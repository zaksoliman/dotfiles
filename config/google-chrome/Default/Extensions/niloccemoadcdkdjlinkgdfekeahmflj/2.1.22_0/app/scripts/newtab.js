...
(function(PKT_EXT){
    ...
    const buildNewTabRecs = function(recData, tabCount){
    ...
    const buildNewTab = function( settings ){
        ...
        .spread(function (recs, trends) {
            ...
            if(recs.state === 'fulfilled'){
                ...
                buildNewTabRecs(recs.value, settings.new_tab_open_count)
            }
    ...
    const returnGoogleTileOption = function( setup ){
        ...
        sendMessage({
            ...
            var showGoogleTiles = setup.new_tab_recent
            if ( !isResponseValid(response) ) {
                sendMessage({
                    action: 'setSetting',
                    key: 'newtab_recents',
                    value: showGoogleTiles
                }, () => {})
            }
